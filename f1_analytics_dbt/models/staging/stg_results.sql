...
select
    ...
    -- race result info
    cast(Position as int64) as finishing_position,      -- after penalties and DSQ if applicable, even if did not finish
    cast(ClassifiedPosition as string) as classified_position, -- integer (if finished) or str (if not); could use dedicated dim table: 
    /*
    ...
    */
    ...
    cast(Time as float64) as total_driver_race_time_seconds,   -- MAY HAVE INCORRECT VALUES; e.g. HAM 2019 first event 21s but finished and 58 completed laps?
